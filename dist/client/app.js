(function () {
  ...
  const alumniProfiles = [
    ...
    },
    {
      ...
      technicalSkills: ["SMAW"],
      positions: ["2G", "3G", "4G"],
      company: "PT Batam Steel Works",
      location: "Batam, Kepulauan Riau",
      experience: "2 tahun 6 bulan",
      employmentStatus: "Sedang bekerja",
      availability: "Tidak mencari aktif",
      skills: ["SMAW", "4G Plate", "Carbon Steel", "Structural", "Grinding"],
      certifications: ["SMAW 4G", "Basic Safety", "Work at Height"],
      program: "SMAW Welder 4G",
      graduation: "Batch Agustus 2023",
      score: "91 / 100",
      currentSince: "Oktober 2023",
      summary:
        "Welder struktur yang berpengalaman mengerjakan sambungan pelat pada posisi 2G hingga 4G untuk proyek fabrikasi baja.",
    },
    {
      id: "yoga-prasetyo",
      initials: "YP",
      name: "Yoga Prasetyo",
      role: "GTAW & SMAW Pipe Welder",
      profession: "Welder",
      technicalSkills: ["GTAW", "SMAW"],
      positions: ["5G", "6G"],
      company: "PT Energi Pipa Indonesia",
      location: "Jakarta Utara, DKI Jakarta",
      experience: "5 tahun",
      employmentStatus: "Sedang bekerja",
      availability: "Terbuka untuk peluang",
      skills: ["GTAW", "SMAW", "5G/6G Pipe", "Root Pass", "Hot Pass"],
      certifications: ["GTAW 6G", "SMAW 6G", "Confined Space"],
      program: "Pipe Welder Qualification",
      graduation: "Batch Maret 2022",
      score: "96 / 100",
      currentSince: "Juni 2022",
      summary:
        "Pipe welder multi-process dengan pengalaman root hingga capping pada pekerjaan instalasi dan maintenance perpipaan.",
    },
    {
      id: "rian-kurniawan",
      initials: "RK",
      name: "Rian Kurniawan",
      role: "FCAW & GMAW Welder",
      profession: "Welder",
      technicalSkills: ["FCAW", "GMAW"],
      positions: ["2G", "3G"],
      company: "Belum bekerja",
      ...
      employmentStatus: "Mencari pekerjaan",
      availability: "Siap segera",
      skills: ["FCAW", "GMAW", "2G/3G Plate", "Flux Core", "Basic Drawing"],
      certifications: ["FCAW 3G", "GMAW 2G", "Basic Safety"],
      program: "FCAW & GMAW Welder",
      graduation: "Batch April 2026",
      score: "87 / 100",
      currentSince: "-",
      summary:
        "Welder produksi dengan pengalaman praktik FCAW dan GMAW yang siap ditempatkan pada pekerjaan manufaktur serta fabrikasi.",
    },
    {
      id: "eko-setiawan",
      initials: "ES",
      ...
      location: "Cilegon, Banten",
      experience: "3 tahun 4 bulan",
      employmentStatus: "Sedang bekerja",
      availability: "Terbuka untuk proyek",
      skills: ["SMAW", "1G/2G/3G", "Fillet Weld", "Fit-up", "K3 Welding"],
      certifications: ["SMAW 3G", "Basic Rigging"],
      program: "SMAW Welder",
      graduation: "Batch Desember 2022",
      score: "90 / 100",
      currentSince: "Februari 2023",
      summary:
        "Welder pelat dengan pengalaman proyek workshop dan lapangan pada pekerjaan struktur ringan hingga menengah.",
    },
    {
      id: "muhammad-iqbal",
      initials: "MI",
      ...
      role: "GTAW Welder 6G",
      profession: "Welder",
      technicalSkills: ["GTAW"],
      positions: ["2G", "5G", "6G"],
      company: "Belum bekerja",
      location: "Bekasi, Jawa Barat",
      experience: "1 tahun 6 bulan",
      employmentStatus: "Mencari pekerjaan",
      availability: "Siap dalam 7 hari",
      skills: ["GTAW", "2G/5G/6G Pipe", "Stainless Steel", "Purging", "Root Pass"],
      certifications: ["GTAW 6G", "Basic Safety"],
      program: "GTAW Welder 6G",
      graduation: "Batch Oktober 2025",
      score: "94 / 100",
      currentSince: "-",
      summary:
        "GTAW welder dengan fokus pada sambungan pipa stainless dan kontrol kualitas root pass untuk kebutuhan industri proses.",
    },
    {
      id: "dewi-anggraini",
      initials: "DA",
      ...
      technicalSkills: ["Visual Inspection", "WPS", "Weld Map"],
      positions: ["Inspector Junior"],
      company: "PT Batam Marine Inspection",
      location: "Batam, Kepulauan Riau",
      experience: "2 tahun",
      employmentStatus: "Sedang bekerja",
      availability: "Terbuka untuk peluang",
      skills: ["Visual Inspection", "WPS", "Weld Map", "Report", "Traceability"],
      certifications: ["Welding Inspector Dasar", "ISO 9001 Awareness"],
      program: "Welding Inspector Dasar",
      graduation: "Batch Juni 2024",
      score: "93 / 100",
      currentSince: "Agustus 2024",
      summary:
        "Inspector junior yang terbiasa memeriksa hasil pengelasan, menjaga traceability, dan menyusun dokumentasi kualitas.",
    },
    {
      id: "rudi-hartono",
      initials: "RH",
      ...
      profession: "Welding Inspector",
      technicalSkills: ["Visual Inspection", "WPS", "NDT Coordination"],
      positions: ["Inspector Intermediate"],
      company: "PT Jawa Quality Services",
      location: "Bekasi, Jawa Barat",
      experience: "4 tahun",
      employmentStatus: "Sedang bekerja",
      availability: "Tidak mencari aktif",
      skills: ["Visual Inspection", "WPS/PQR", "NDT Coordination", "ITP", "Final Report"],
      certifications: ["Welding Inspector", "NDT Awareness", "ISO 9001"],
      program: "Welding Inspector Intermediate",
      graduation: "Batch Februari 2023",
      score: "95 / 100",
      currentSince: "April 2023",
      summary:
        "Welding inspector dengan pengalaman koordinasi inspeksi, verifikasi WPS, dan penyusunan laporan mutu proyek.",
    },
    {
      id: "maya-lestari",
      initials: "ML",
      ...
      role: "Welding Inspector Junior",
      profession: "Welding Inspector",
      technicalSkills: ["Visual Inspection", "Weld Map"],
      positions: ["Inspector Junior"],
      company: "Belum bekerja",
      location: "Tangerang, Banten",
      experience: "Fresh graduate",
      employmentStatus: "Mencari pekerjaan",
      availability: "Siap segera",
      skills: ["Visual Inspection", "Weld Map", "Dimensional Check", "Report", "QC Basic"],
      certifications: ["Welding Inspector Dasar", "Basic Safety"],
      program: "Welding Inspector Dasar",
      graduation: "Batch Juli 2026",
      score: "89 / 100",
      currentSince: "-",
      summary:
        "Lulusan inspector dasar yang teliti dalam pemeriksaan visual, pencatatan ketidaksesuaian, dan dokumentasi weld map.",
    },
    {
      id: "arif-nugroho",
      initials: "AN",
      ...
      technicalSkills: ["Visual Inspection", "WPS", "NDT Coordination"],
      positions: ["Inspector Intermediate"],
      company: "PT Serang Industrial Inspection",
      location: "Serang, Banten",
      experience: "3 tahun",
      employmentStatus: "Sedang bekerja",
      availability: "Terbuka untuk peluang",
      skills: ["Visual Inspection", "WPS/PQR", "NDT Coordination", "Weld Map", "Punch List"],
      certifications: ["Welding Inspector", "Liquid Penetrant Awareness"],
      program: "Welding Inspector Intermediate",
      graduation: "Batch September 2023",
      score: "92 / 100",
      currentSince: "November 2023",
      summary:
        "Inspector berpengalaman pada kontrol dokumen, inspeksi visual, dan koordinasi tindak lanjut temuan pekerjaan welding.",
    },
    {
      id: "aldi-syahputra",
      initials: "AS",
      ...
      profession: "Fitter",
      technicalSkills: ["Fit-up", "Isometric Drawing"],
      positions: ["Structural Fitter"],
      company: "PT Batam Heavy Fabrication",
      location: "Batam, Kepulauan Riau",
      experience: "3 tahun",
      employmentStatus: "Sedang bekerja",
      availability: "Terbuka untuk proyek",
      skills: ["Fit-up", "Structural Drawing", "Measurement", "Tack Weld", "Alignment"],
      certifications: ["Structural Fitting", "Basic Rigging", "Basic Safety"],
      program: "Structural Fitter",
      graduation: "Batch Januari 2023",
      score: "91 / 100",
      currentSince: "Maret 2023",
      summary:
        "Structural fitter dengan pengalaman membaca drawing, marking, fit-up, dan alignment komponen fabrikasi baja.",
    },
    {
      id: "yudi-santoso",
      initials: "YS",
      ...
      company: "Belum bekerja",
      location: "Jakarta Utara, DKI Jakarta",
      experience: "1 tahun 3 bulan",
      employmentStatus: "Mencari pekerjaan",
      availability: "Siap segera",
      skills: ["Fit-up", "Isometric Drawing", "Pipe Measurement", "Flange", "Support"],
      certifications: ["Basic Pipe Fitting", "Basic Safety"],
      program: "Basic Pipe Fitter",
      graduation: "Batch Maret 2026",
      score: "88 / 100",
      currentSince: "-",
      summary:
        "Pipe fitter yang memahami gambar isometrik, pengukuran, flange alignment, serta persiapan sambungan sebelum welding.",
    },
    {
      id: "rahmat-hidayat",
      initials: "RH",
      ...
      technicalSkills: ["Fit-up", "Isometric Drawing"],
      positions: ["Pipe Fitter"],
      company: "PT Nusantara Piping Solution",
      location: "Cilegon, Banten",
      experience: "4 tahun",
      employmentStatus: "Sedang bekerja",
      availability: "Tidak mencari aktif",
      skills: ["Fit-up", "Isometric Drawing", "Spool", "Flange Alignment", "Pipe Support"],
      certifications: ["Pipe Fitting", "Basic Rigging", "Work at Height"],
      program: "Pipe Fitter Intermediate",
      graduation: "Batch Mei 2022",
      score: "94 / 100",
      currentSince: "Juli 2022",
      summary:
        "Pipe fitter berpengalaman pada fabrikasi spool, instalasi support, dan alignment sistem perpipaan industri.",
    },
    {
      id: "ilham-akbar",
      initials: "IA",
      name: "Ilham Akbar",
      role: "Pipe & Structural Fitter",
      profession: "Fitter",
      technicalSkills: ["Fit-up", "Isometric Drawing", "Pipe Measurement"],
      positions: ["Pipe Fitter", "Structural Fitter"],
      company: "Belum bekerja",
      location: "Karawang, Jawa Barat",
      experience: "2 tahun",
      employmentStatus: "Mencari pekerjaan",
      availability: "Siap dalam 14 hari",
      skills: ["Fit-up", "Isometric Drawing", "Structural Drawing", "Measurement", "Alignment"],
      certifications: ["Pipe Fitting", "Structural Fitting", "Basic Safety"],
      program: "Fitter Multi-skill",
      graduation: "Batch Desember 2024",
      score: "90 / 100",
      currentSince: "-",
      summary:
        "Fitter multi-skill yang mampu menangani persiapan sambungan pipa dan struktur berdasarkan drawing serta toleransi kerja.",
    },
  ];
  ...
  const welderDirectoryMeta = {
    ...
    "ahmad-fauzi": {
      ...
      graduationYear: "2023",
      certificate: "Aktif",
      certificateNumber: "AA-SMAW-2023-00164",
      certificateUntil: "22 Agustus 2027",
      readyDate: "Perlu konfirmasi",
      birth: "Batam, 21 Mei 1998",
      phone: "0813-7012-4586",
      email: "a.fauzi@example.id",
    },
    "yoga-prasetyo": {
      domicile: "Jakarta Utara, DKI Jakarta",
      graduationYear: "2022",
      certificate: "Aktif",
      certificateNumber: "AA-WQT-2022-00058",
      certificateUntil: "15 Maret 2027",
      readyDate: "30 hari setelah konfirmasi",
      birth: "Jakarta, 8 Agustus 1995",
      phone: "0812-1184-7603",
      email: "y.prasetyo@example.id",
    },
    "rian-kurniawan": {
      domicile: "Karawang, Jawa Barat",
      graduationYear: "2026",
      certificate: "Aktif",
      certificateNumber: "AA-FG-2026-00112",
      certificateUntil: "16 April 2029",
      readyDate: "Siap segera",
      birth: "Karawang, 17 Januari 2002",
      phone: "0857-9230-1448",
      email: "r.kurniawan@example.id",
    },
    "eko-setiawan": {
      domicile: "Cilegon, Banten",
      graduationYear: "2022",
      certificate: "Aktif",
      certificateNumber: "AA-SMAW-2022-00201",
      certificateUntil: "9 Desember 2027",
      readyDate: "14 hari setelah konfirmasi",
      birth: "Cilegon, 25 September 1997",
      phone: "0819-8402-6671",
      email: "e.setiawan@example.id",
    },
    "muhammad-iqbal": {
      domicile: "Bekasi, Jawa Barat",
      graduationYear: "2025",
      certificate: "Aktif",
      certificateNumber: "AA-GTAW-2025-00147",
      certificateUntil: "28 Oktober 2028",
      readyDate: "Siap dalam 7 hari",
      birth: "Bekasi, 4 April 2000",
      phone: "0821-4185-9907",
      email: "m.iqbal@example.id",
    },
    "dewi-anggraini": {
      domicile: "Batam, Kepulauan Riau",
      graduationYear: "2024",
      certificate: "Aktif",
      certificateNumber: "AA-WID-2024-00063",
      certificateUntil: "14 Juni 2028",
      readyDate: "30 hari setelah konfirmasi",
      birth: "Batam, 10 Desember 1999",
      phone: "0812-7709-2465",
      email: "d.anggraini@example.id",
    },
    "rudi-hartono": {
      domicile: "Bekasi, Jawa Barat",
      graduationYear: "2023",
      certificate: "Aktif",
      certificateNumber: "AA-WII-2023-00028",
      certificateUntil: "11 Februari 2028",
      readyDate: "Perlu konfirmasi",
      birth: "Bekasi, 19 Juli 1994",
      phone: "0813-8891-3027",
      email: "r.hartono@example.id",
    },
    "maya-lestari": {
      domicile: "Tangerang, Banten",
      graduationYear: "2026",
      certificate: "Aktif",
      certificateNumber: "AA-WID-2026-00077",
      certificateUntil: "20 Juli 2029",
      readyDate: "Siap segera",
      birth: "Tangerang, 13 November 2002",
      phone: "0856-2074-5819",
      email: "m.lestari@example.id",
    },
    "arif-nugroho": {
      domicile: "Serang, Banten",
      graduationYear: "2023",
      certificate: "Aktif",
      certificateNumber: "AA-WII-2023-00095",
      certificateUntil: "17 September 2028",
      readyDate: "30 hari setelah konfirmasi",
      birth: "Serang, 2 Februari 1996",
      phone: "0812-9365-1740",
      email: "a.nugroho@example.id",
    },
    "aldi-syahputra": {
      domicile: "Batam, Kepulauan Riau",
      graduationYear: "2023",
      certificate: "Aktif",
      certificateNumber: "AA-SF-2023-00044",
      certificateUntil: "26 Januari 2028",
      readyDate: "14 hari setelah konfirmasi",
      birth: "Batam, 30 Juni 1997",
      phone: "0813-7210-6598",
      email: "a.syahputra@example.id",
    },
    "yudi-santoso": {
      domicile: "Jakarta Utara, DKI Jakarta",
      graduationYear: "2026",
      certificate: "Aktif",
      certificateNumber: "AA-PF-2026-00084",
      certificateUntil: "12 Maret 2029",
      readyDate: "Siap segera",
      birth: "Jakarta, 7 Juli 2001",
      phone: "0818-4920-7135",
      email: "y.santoso@example.id",
    },
    "rahmat-hidayat": {
      domicile: "Cilegon, Banten",
      graduationYear: "2022",
      certificate: "Aktif",
      certificateNumber: "AA-PFI-2022-00019",
      certificateUntil: "23 Mei 2027",
      readyDate: "Perlu konfirmasi",
      birth: "Cilegon, 16 Oktober 1995",
      phone: "0812-6037-8451",
      email: "rahmat.h@example.id",
    },
    "ilham-akbar": {
      domicile: "Karawang, Jawa Barat",
      graduationYear: "2024",
      certificate: "Aktif",
      certificateNumber: "AA-FMS-2024-00037",
      certificateUntil: "5 Desember 2028",
      readyDate: "Siap dalam 14 hari",
      birth: "Karawang, 27 Maret 1999",
      phone: "0857-3108-6429",
      email: "i.akbar@example.id",
    },
  };
  ...
  function welderAvatar(profile, large = false) {
    const tones = {
      ...
      "maya-lestari": "orange",
      "arif-nugroho": "blue",
      "aldi-syahputra": "green",
      "yudi-santoso": "cyan",
      "rahmat-hidayat": "slate",
      "ilham-akbar": "teal",
    };
          ...
          <main class="welder-directory-main">
            <form class="welder-search-panel" data-form="welder-search">
              ...
              <div class="welder-filter-grid">
                ...
                <label><span>Posisi / Kualifikasi</span><select name="position" data-welder-filter><option value="">Semua Kualifikasi</option>${["1G", "2G", "3G", "4G", "5G", "6G", "Inspector Junior", "Inspector Intermediate", "Pipe Fitter", "Structural Fitter"].map((value) => `<option ${state.welderFilters.position === value ? "selected" : ""}>${value}</option>`).join("")}</select></label>
